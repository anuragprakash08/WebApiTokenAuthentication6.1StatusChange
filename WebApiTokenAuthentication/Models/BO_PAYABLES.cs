...
{
    public sealed class BO_PAYABLES
    {
        ...
        public string PAYABLES_ID { get; set; } = string.Empty;
        ...
        public DateTime REQ_PAYABLE_DT { get; set; } = new DateTime(1900, 1, 1);
        public DateTime PAYABLE_DT { get; set; } = new DateTime(1900, 1, 1);
        public string PAYABLE_DT_STR { get; set; } = string.Empty;
        ...
        public decimal PAYABLE_AMT_LCY { get; set; }
        public decimal PAYABLE_AMT_FCY { get; set; }
        public decimal PAYABLE_AMT_VCY { get; set; }
        public string PAYABLE_AMT_CCY { get; set; } = string.Empty;
        public string PYMT_STATUS_FLG { get; set; } = string.Empty;
        public string REF_RCPT_VOUCHER_ID { get; set; } = string.Empty;
        public decimal PAID_AMT_LCY { get; set; }
        public decimal PAID_AMT_FCY { get; set; }
        public decimal PAID_AMT_VCY { get; set; }
        public string PAID_AMT_CCY { get; set; } = string.Empty;
        ...
        public string RECEIVABLE_TYPE { get; set; } = string.Empty;
        ...
        public string PYMT_PARTY { get; set; } = string.Empty;
        public string PYMT_PARTY_NAME { get; set; } = string.Empty;
        public string PYMT_PRJ { get; set; } = string.Empty;
        public string PYMT_PRJ_NAME { get; set; } = string.Empty;
        public string PREF_SET_TYPE { get; set; } = string.Empty;
        public string PREF_INST_TYPE { get; set; } = string.Empty;
        public string PREF_INST_ID { get; set; } = string.Empty;
        public string PREF_BANK { get; set; } = string.Empty;
        public string PREF_BRANCH { get; set; } = string.Empty;
        public string PREF_ACID { get; set; } = string.Empty;
        public string PYMT_PARTY_BANK_ID { get; set; } = string.Empty;
        public string PYMT_PARTY_BRANCH { get; set; } = string.Empty;
        public string PYMT_PARTY_ACID { get; set; } = string.Empty;
        ...
        public string PYMT_PREF_SRC_FLG { get; set; } = string.Empty;
        public string INSTR_CPARTY { get; set; } = string.Empty;
        public string INSTR_CPARTY_NAME { get; set; } = string.Empty;
        public string AUTO_DEBIT_FLG { get; set; } = string.Empty;
        ...
        public decimal SYS_PAYABLE_AMT_FCY { get; set; }
        public decimal SYS_PAYABLE_AMT_LCY { get; set; }
        public string SYS_PAYABLE_AMT_CCY { get; set; } = string.Empty;
